...
export default async function AdminFacultyPage() {
  ...
  return (
    <div className="admin-content-wrap">
      <div className="admin-faculty-header" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 20, marginBottom: 36, flexWrap: "wrap" }}>
        <div>
          <h1 style={{ margin: "0 0 8px", fontFamily: DISPLAY, fontSize: 28, fontWeight: 500, color: IVORY_100 }}>Faculty</h1>
          <p style={{ margin: 0, fontFamily: SANS, fontSize: 14, color: "rgba(248,243,232,0.5)" }}>Manage faculty profiles and photographs.</p>
        </div>
        <Link
      ...
      {error ? (
        <div style={{ border: "1px solid rgba(229,115,115,0.3)", background: "rgba(229,115,115,0.06)", padding: "24px", borderRadius: 3 }}>
          <p style={{ margin: "0 0 6px", fontFamily: SANS, fontSize: 13.5, color: "#E57373", fontWeight: 600 }}>Could not load faculty records.</p>
          <p style={{ margin: 0, fontFamily: SANS, fontSize: 12.5, color: "rgba(248,243,232,0.55)" }}>
            ...
            <code>supabase/migrations/0001_faculty.sql</code> has been run in your Supabase project.
          </p>
        </div>
      ) : (
