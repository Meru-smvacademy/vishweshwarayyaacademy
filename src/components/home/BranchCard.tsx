...
export default function BranchCard({ name, description, image, imageAlt }: BranchCardProps) {
  return (
    <div className="group flex h-auto min-h-[260px] flex-1 items-center gap-4 rounded-[28px] border border-scholarship-navy/5 bg-white p-6 shadow-[0px_16px_20px_0px_rgba(22,58,99,0.08)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0px_22px_26px_0px_rgba(22,58,99,0.14)] xl:h-[260px]">
      ...
      <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-2xl xl:h-[220px] xl:w-[220px]">
