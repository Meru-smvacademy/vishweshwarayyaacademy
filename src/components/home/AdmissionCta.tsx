...
// Decorative background glyphs, scoped to this section only — exact path
// data from the approved Figma frame's exported assets.
        ...
        >
          ...
          <div className="relative mx-auto flex max-w-[760px] flex-col items-center gap-6 text-center">
            ...
            <p className="max-w-[600px] text-[16px] font-normal leading-[1.6] text-white/75">
              Understanding every student. Adapting the way they learn. Preparing them for NEET,
              JEE &amp; KCET.
            </p>
