...
const MESSAGE_PARAGRAPHS = [
  ...
  "Every student who joins Sir M V Academy comes with a dream. Our responsibility is to transform that dream into knowledge, confidence, character, and purpose. Success is not measured only by ranks or admissions, but by the positive impact our students create in the lives of others.",
